...
{text = 'آشـترگ بآلقنآ‌‏هہ ',url='https://telegram.me/'..Channel:gsub("@","")}}}   
...
if redis:get(mero.."chencher"..msg.sender_user_id_) then 
if redis:get(mero.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
tahan = '['..(redis:get(mero.."chencher"..msg.sender_user_id_) or '')..']'
...
redis:set(mero.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
end
return {
