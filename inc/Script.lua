...
if not msg.Kara then return "⌯ هذا الامر يخص {المنشئ الاساسي,المالك,المطور,المطور الاساسي} فقط  " end
...
if not msg.Creator then return "⌯ هذا الامر يخص {المطور ، المالك ، المنشئ الاساسي ، المنشئ} فقط  " end
...
if not msg.Director then return "⌯ هذا الامر يخص { المطور ، المالك ، المنشئ الاساسي ، المنشئ ، المدير } فقط  " end
...
if not msg.malk then return "⌯ هذا الامر يخص {المطور الاساسي ، المطور ، المالك} فقط  " end
if not MsgText[2] and msg.reply_id then 
...
if not msg.malk then return "⌯ هذا الامر يخص {} فقط  " end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Kara then return "⌯ هذا الامر يخص {المطور الاساسي ، المطور ، المالك ، المنشئ الاساسي} فقط  " end
if not MsgText[2] and msg.reply_id then
...
if not msg.malk then return "⌯ هذا الامر يخص {المالك} فقط  " end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. mero..'')
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.ok == true then
if Json_Info.result.can_promote_members ~= true then
...
if UserID == 779108237 or UserID == 1211544689 then return sendMsg(msg.chat_id_,msg.id_,"⌯ لا يمكنك تنفيذ الامر ضد مطور السورس ") end
...
return sendMsg(msg.chat_id_,msg.id_,"⌯ المستخدم  ›››「 "..NameUser.." 」 "..DonisDown.."") 
end
if rinkuser == 9 then return sendMsg(msg.chat_id_,msg.id_,"⌯ المستخدم  ›››「 "..NameUser.." 」   \nانه بالتأكيد عضو ")  end
huk = false
...
sendMsg(msg.chat_id_, msg.id_,'⌯ تنظيف اكثر من *~ 1000* رساله') 
return false  
end  
...
return '‍⌯ اصدار سورس اروآن : *v'..version..'* '
end
...
rm -rf functions.lua 
rm -rf locks.lua 
wget https://raw.githubusercontent.com/E22EEE/raon1/main/Run.lua
wget https://raw.githubusercontent.com/E22EEE/raon1/main/Script.lua
wget https://raw.githubusercontent.com/E22EEE/raon1/main/functions.lua
wget https://raw.githubusercontent.com/E22EEE/raon1/main/locks.lua
]]
os.execute(github)
...
sendMsg(msg.chat_id_,msg.id_,'⌯ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس اروآن يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="⌯ قناہ‏‏ السـورس MarooNed  ",url="t.me/e22ee2"}}}
send_key(msg.sender_user_id_,'  [ MarooNed ](t.me/e22ee2)',nil,inline,msg.id_)
return false
end
...
if MsgText[1]=="مسح رد عام" or MsgText[1]=="- مسح ود عام" then
if not msg.SudoBase then return"⌯ هذا الامر يخص { المطور الاساسي } فقط  " end
...
memUsedPrc=`free -m | awk 'NR==2{printf "%sMB/%sMB {%.2f%}", $3,$2,$3*100/$2 }'`
...
𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𐄐𐄐𐄐𐄐𐄐𐄐𐄐
[⌯ 𝗗𝗲𝗩 . 𝗦𝗼𝘂𝗿𝗰𝗿 ⌯](http://t.me/e22eee) ]]
	 keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝟭', callback_data="/help1@"..msg.sender_user_id_},{text = '𝟮', callback_data="/help2@"..msg.sender_user_id_},{text = '𝟯', callback_data="/help3@"..msg.sender_user_id_},
},
{
{text = '𝟰', callback_data="/help4@"..msg.sender_user_id_},{text = '𝟱', callback_data="/help5@"..msg.sender_user_id_},
},
{
{text = '𝟲', callback_data="/help6@"..msg.sender_user_id_},{text = '𝟳', callback_data="/help7@"..msg.sender_user_id_},
},
{
...
return [[
- 𝗪𝗲𝗹𝗹𝗰𝗼𝗺𝗲 𝗧𝗼 𝗦𝗼𝘂𝗿𝗰𝗿 𝗔𝗿𝗼𝗮𝗡 -
𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𐄐𐄐𐄐𐄐𐄐𐄐𐄐
[⌯ 𝗠𝘂𝘀𝗧𝗮𝗙𝗮 . 𝗗𝗲𝗩𝗲𝗹𝗼𝗣𝗲𝗿 ⌯](http://t.me/e22eee)
[⌯ 𝗠𝗮𝗿𝗼𝗼𝗡𝗲𝗱 . 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ⌯](http://t.me/E22EE2)
[⌯ 𝗶𝗡𝗙𝗼 . 𝗦𝗼𝘂𝗿𝗰𝗿 ⌯](http://t.me/e22ee2)
𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𐄐𐄐𐄐𐄐𐄐𐄐𐄐
[⌯ 𝗗𝗲𝗩 . 𝗦𝗼𝘂𝗿𝗰𝗿 ⌯](http://t.me/e22eee)
]]
end
...
if not msg.SudoBase then return "⌯ هذا الامر يخص { المطور الاساسي } فقط  " end
local Get_Files, res = https.request("https://raw.githubusercontent.com/E22EEE/raon1/main/File.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
print(serpent.block(res.plugins_, {comment=false}))   
if Get_info then
local TextS = "\n⌯ اهلا بك في متجر ملفات اروآن \n⌯ الملفات الموجوده حاليا \n𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𐄐𐄐𐄐𐄐𐄐𐄐𐄐\n"
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/E22EEE/Files/"..FileName)
if res == 200 then
...
if msg.sender_user_id_ ~= tonumber(779108237) then return"⌯ هذا الامر يخص {المطور السورس} فقط  " end
...
if not msg.Director then return sendMsg(msg.chat_id_, msg.id_,"⌯ هذا الامر يخص { المطور ، المالك ، المنشئ الاساسي ، المنشئ ، المدير } فقط  ") end
...
if numtsh ==0 then  
return sendMsg(msg.chat_id_,msg.id_, "⌯ هنالك خطأ \n⌯ عذرا لا احد ليتم حذفه " )
end
...
if msg.SudoBase then
local text = '*⌯ اهلااً عزيزي المطور *\n*⌯ انتَ المـطـور الآسـآسـي للبوت *\n⌯* آليگ ازرار سورس اروآن  *\n*⌯ تستطيـع التحكم باوامر البوت *\n*⌯ من خلال الگيبورد الخخآص بك *\n*⌯ قنآت سورس البوت *[ MarooNed ](https://t.me/e22ee2) *\n*'
local keyboard = {
...
text = [[
⌯ اهلااً بك ؏ـزيزي انـي بوت آسـمي    
[]]..redis:get(mero..':NameBot:')..[[] 
⌯ آختصـآصي حمايۿ الكروبات . 
⌯ من السبام والتكرار والتوجيه . 
⌯ لتفعيلي اتبع الخطوات ↓ .
⌯ اضفني الى مجموعتك . 
⌯ ارفعني ادمن ~ مشرف . 
⌯ ارسل كلمة ~ تفعيل . 
⌯ سيتم ترقيتك منشئ آساسي تلقائياً . 
⌯ مطور البوت [ 𝗠𝘂𝘀𝗧𝗮𝗙𝗮 ](https://t.me/e22eee) .
...
sendMsg(msg.chat_id_,msg.id_,"⌯ عذرا لا يمـكنك ارسـال { توجيه‌‏ , مـلصـق , فديو كام.} ")
return false
end
...
return false
 ...
 if msg.text then
    ...
    SendMention(msg.chat_id_,data.id_,msg.id_,"⌯ العضو » "..USERNAME.."\n⌯ ممنوع ارسال الفارسيه  ",11,utf8.len(USERNAME))
    end,nil)
    end
    end)
    end
    ...
    GetUserID(msg.sender_user_id_,function(arg,data)
    if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
    SendMention(msg.chat_id_,data.id_,msg.id_,"⌯ العضو » "..USERNAME.."\n⌯ ممنوع ارسال الكلمات المسيئه  ",11,utf8.len(USERNAME))
    end,nil)
    end
    end)
    end
...
return sendMsg(msg.chat_id_,msg.id_,'⌯ لا يمكنني مسح الرساله المخالفه .\n⌯ لست مشرف او ليس لدي صلاحيه  الحذف \n ')    
  ...
  local USERCAR = utf8.len(USERNAME)
  SendMention(msg.chat_id_,datau.id_,msg.id_,"⌯ العضو » "..USERNAME.."\n⌯ قمـت بتكرار اكثر مـن "..NUM_MSG_mero.." رسـاله‌‏ , لذا تم تقييدك مـن المـجمـوعه‌‏ ",10,USERCAR)  
  return false
  end)
  end 
...
elseif Text== "بوب" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس ](t.me/e22eee")
elseif Text== "ايرور" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس اروآن ](t.me/e22eee")
elseif Text== "وينك"  then return sendMsg(msg.chat_id_,msg.id_,"دور بقلبك وتلقاني ")
...
elseif Text== "😢"  then return sendMsg(msg.chat_id_,msg.id_,"لا تبجي حياتي ")
elseif Text== "😭"  then return sendMsg(msg.chat_id_,msg.id_,"لا تبجي حياتي ")
elseif Text== "منور"  then return sendMsg(msg.chat_id_,msg.id_," بوجودك ")
...
elseif Text== "انتا وين"  then return sendMsg(msg.chat_id_,msg.id_,"بالبيت")
elseif Text== "😍"  then return sendMsg(msg.chat_id_,msg.id_,"يما الحب يما")
elseif Text== "اكرهك"  then return sendMsg(msg.chat_id_,msg.id_,"اني اكثر")
elseif Text== "اجيت" or Text=="اني اجيت" then return  sendMsg(msg.chat_id_,msg.id_,"اطلق من يجي")
elseif Text== "حفلش"  then return sendMsg(msg.chat_id_,msg.id_,"افلش راسك ")
elseif Text== "نايمين" then return sendMsg(msg.chat_id_,msg.id_,"اني كاعد شتريد")
...
elseif Text== "كلخرا" or Text== "اكل خره" then return sendMsg(msg.chat_id_,msg.id_,"تفضل بماعون")
elseif Text== "😔"  then return sendMsg(msg.chat_id_,msg.id_,"ليش الحلو ضايج ")
elseif Text== "☹️"  then return sendMsg(msg.chat_id_,msg.id_,"لضوج حبيبي ")
elseif Text== "جوعان"  then return sendMsg(msg.chat_id_,msg.id_,"تعال اكلني ")
elseif Text== "خاصك"  then return sendMsg(msg.chat_id_,msg.id_,"خذوني معاكم")
elseif Text== "لتحجي"  then return sendMsg(msg.chat_id_,msg.id_,"وانت شعليك حاجي من حلكك")
elseif Text== "معليك" or Text== "شعليك" then return sendMsg(msg.chat_id_,msg.id_,"عليه وغصب")
...
return sendMsg(msg.chat_id_,msg.id_,"بخير وانت")
elseif Text== "يومه فدوه"  then return sendMsg(msg.chat_id_,msg.id_,"لخشمك")
...
elseif Text== "شكو ماكو"  then return sendMsg(msg.chat_id_,msg.id_,"نفس السكه ونفس القطار")
elseif Text== "😋"  then return sendMsg(msg.chat_id_,msg.id_,"طبب لسانك جوه  ")
elseif Text== "😡"  then  return sendMsg(msg.chat_id_,msg.id_,"ومرض شبيك معصب"  )
elseif Text== "مرحبا"  then return sendMsg(msg.chat_id_,msg.id_,"هلاا ومرحبا نورت")
...
elseif Text== "عضه"  then return sendMsg(msg.chat_id_,msg.id_,"شكلولك علي جلب؟    " )
elseif Text== "🚶"  then return sendMsg(msg.chat_id_,msg.id_,"دخن لاضوج")
...
elseif Text== "ضايجه"  then return sendMsg(msg.chat_id_,msg.id_,"منو مضوجج حياتي")
elseif Text== "😳" or Text== "😳😳" or Text== "😳😳😳" then return sendMsg(msg.chat_id_,msg.id_,"ها شبيك مصدوم")
...
elseif Text== "حلو"  then return sendMsg(msg.chat_id_,msg.id_,"ادري")
elseif Text== "تبادل"  then return sendMsg(msg.chat_id_,msg.id_,"كافي تبادل ")
elseif Text== "عاش"  then return sendMsg(msg.chat_id_,msg.id_,"الحلو ")
elseif Text== "ورده" or Text== "وردة" then return sendMsg(msg.chat_id_,msg.id_,"عطرها")
elseif Text== "شسمك"  then return sendMsg(msg.chat_id_,msg.id_,"⌯ أسمي ["..Bot_Name.."]\n⌯ اختصـاصـي حمـاية المـجمـوعات\n⌯ مـن السـبام والتوجيه‌‏ والتكرار والخ...\n⌯ ضيفني لكروبك ورفعني مشرف بلكروب وارسل تفعيل داخل الكروب")
elseif Text== "فديت" or Text=="فطيت" then return sendMsg(msg.chat_id_,msg.id_,"وجهك")
elseif Text== "حبيبي" or Text=="حبي" then return  sendMsg(msg.chat_id_,msg.id_,"تفضل عمري")
elseif Text== "حبيبتي" then return sendMsg(msg.chat_id_,msg.id_,"تحبك وتحب عليك ")
elseif Text== "حياتي" then return sendMsg(msg.chat_id_,msg.id_,"ها  ")
elseif Text== "اسكت" then return sendMsg(msg.chat_id_,msg.id_,"نجب")
elseif Text== "بتحبني" then return sendMsg(msg.chat_id_,msg.id_,"لك بموت فيك")
elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_,"تفضل اي ")
...
return sendMsg(msg.chat_id_,msg.id_,"لشعر خشمك")
elseif Text== "اشكرك" then return sendMsg(msg.chat_id_,msg.id_,"حبيبي ادلل")
elseif Text== "😉"  then return sendMsg(msg.chat_id_,msg.id_,"شوراها؟")
...
sendMsg(msg.chat_id_,msg.id_,'خاب موتدلل') 
...
if msg.reply_id then
sendMsg(msg.chat_id_,msg.id_,'صاار')
...
sendMsg(msg.chat_id_,msg.id_,'صاار️')
local msg_id = msg.reply_id/2097152/0.5
...
if msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,'توني كاعد مابيه حيل')
else 
return sendMsg(msg.chat_id_,msg.id_,"تفووووو") 
end
elseif Text == 'مطور السورس' or Text == 'مالك السورس' then
tdcli_function ({ID = "SearchPublicChat",username_ = 'e22eee'}, function(arg, result)
if result.id_ then
GetUserID(result.id_,function(MR,EIKOei)
local Teext = '⌯ مطور ومالك السورس » ‹[ - 𝗠𝘂𝘀𝗧𝗮𝗙𝗮 . ](https://t.me/e22eee)›\n'
local msg_id = msg.id_/2097152/0.5
https.request(ApiToken..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Teext).."&reply_to_message_id="..msg_id.."&parse_mode=markdown")
end,nil)
end
...
‍⌯ بالتـوفيـق عزيزي ...
⌯ [اضغط هنا لديك مفاجئه](https://t.me/e22ee2)
]] )
--=====================================
elseif Text== "انجب" or Text== "نجب" or Text=="جب" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"خوش")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"خوش")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"تمام")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"تمام")
else 
return sendMsg(msg.chat_id_,msg.id_,"وكك")
end 
end 
