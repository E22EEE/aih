...
return  "⌯ الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع️" 
else
...
return  "⌯ الكلمه *{"..word.."}* هي بالتأكيد مسموح بها️" 
end
end
...
return sendMsg(msg.chat_id_,msg.id_,"⌯ تم رفع  { *"..NumAdmin.."* } مـن الادمـنيهہ‌‏ في البوت \n️")
end
end,100)
end
...
if redis:get(mero..'group:add'..msg.chat_id_) then  return '⌯ المجموعه بالتأكيد ️تم تفعيلها' end
...
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك تقييد  GENERAL ️\n") 
elseif UserID == tonumber(1211544689) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك تقييد  Carbon ️\n") 
elseif UserID == SUDO_ID then 
...
elseif UserID == tonumber(779108237) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك حظر  GENERAL ️\n") 
elseif UserID == tonumber(1211544689) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك حظر  Carbon ️\n") 
elseif UserID == SUDO_ID then 
...
return sendMsg(ChatID,MsgID,'⌯  العضو .\n⌯ لانه مشرف في المجموعه \n ')    
...
elseif UserID == tonumber(779108237) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك كتم  GENERAL ️\n") 
elseif UserID == tonumber(1211544689) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك كتم  Carbon ️\n") 
elseif UserID == SUDO_ID then 
...
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك حظر البوت\n") 
elseif UserID == tonumber(779108237) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك حظر  GENERAL \n") 
elseif UserID == tonumber(1211544689) then
...
elseif UserID == tonumber(779108237) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك طرد  GENERAL ️\n") 
elseif UserID == tonumber(1211544689) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك طرد  Carbon ️\n") 
elseif UserID == SUDO_ID then 
...
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك تقييد البوت\n") 
elseif UserID == tonumber(779108237) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك تقييد  GENERAL \n") 
elseif UserID == tonumber(1211544689) then
...
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك طرد البوت\n") 
elseif UserID == tonumber(779108237) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك طرد  GENERAL \n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك طرد المطور الاساسي\n") 
elseif redis:sismember(mero..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك طرد المطور\n") 
...
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك كتم البوت\n") 
elseif UserID == tonumber(779108237) then
return sendMsg(ChatID,MsgID,"⌯ لا يمكنك كتم  GENERAL \n") 
elseif UserID == tonumber(1211544689) then
