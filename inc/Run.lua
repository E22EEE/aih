...
local function download(file_id, dl_cb, cmd)
  ...
  msg.TheRankCmd = '  GENERAL  ' 
  msg.TheRank = '  GENERAL  ️' 
  msg.Rank = 11
...
keyboard = {} 
  keyboard.inline_keyboard = {
  {
  {text = '  ᯫ𝟭', callback_data="/help1@"..data.sender_user_id_},{text = '  ᯫ𝟮', callback_data="/help2@"..data.sender_user_id_},{text = '  ᯫ𝟯', callback_data="/help3@"..data.sender_user_id_},
  },
  {
  {text = '  ᯫ𝟰', callback_data="/help4@"..data.sender_user_id_},{text = '  ᯫ𝟱', callback_data="/help5@"..data.sender_user_id_},
  },
  {
  {text = '  ᯫ𝟲', callback_data="/help6@"..data.sender_user_id_},{text = '  ᯫ𝟳', callback_data="/help7@"..data.sender_user_id_},
  },
  {
{text = '  ᯫ𝗚𝗮𝗺𝘀 ', callback_data="/helpgames@"..data.sender_user_id_},
},
...
{text = '  ᯫ𝗚𝗮𝗺𝘀 ', callback_data="/helpgames@"..data.sender_user_id_},
		...
		answerCallbackQuery(data.id_,'قائمة الاوامر ليست لك', true)
		  ...
		  download_file('https://raw.githubusercontent.com/E22EEE/aih/main/inc/Run.lua','./inc/Run.lua')
		  EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
		  download_file('https://raw.githubusercontent.com/E22EEE/aih/main/inc/locks.lua','./inc/locks.lua')
		  EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
		  download_file('https://raw.githubusercontent.com/E22EEE/aih/main/inc/Script.lua','./inc/Script.lua')
		  EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
		  download_file('https://raw.githubusercontent.com/E22EEE/aih/main/inc/functions.lua','./inc/functions.lua')
		  download_file('https://raw.githubusercontent.com/E22EEE/aih/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
		  download_file('https://raw.githubusercontent.com/E22EEE/aih/main/plugins/games.lua','./plugins/games.lua')
